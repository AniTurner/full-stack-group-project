            ...
            <main>
                <div id="user-info-edit-screen" className="center-crop">
                    ...
                    <form id="user-info-form" style={{padding:20 , display:"grid", justifyContent: "center" , alignItems:"center"}} onSubmit={this.handleSubmit}>
                        <img style={{width:150,height: 150,float:"left",marginRight:20,borderRadius:100}} src={this.state.imgUrl ? this.state.imgUrl : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROJlZBm6kPxbsgHqvL2GNBMrLY_Ns4mhJFiOa4L1Sgkz1u-J2gtg" } alt={this.state.username}/>
